...
import { ChevronUp, ChevronDown, Maximize, Play, Pause } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="fixed right-8 top-1/2 transform -translate-y-1/2 z-50 flex flex-col gap-4 items-center">
        ...
        <button 
          onClick={togglePlay}
          className={`w-10 h-10 mt-2 rounded-full glass-card flex items-center justify-center transition-all shadow-md backdrop-blur-md border border-white ${isPlaying ? 'bg-brand-emerald text-white border-brand-emerald' : 'text-brand-dark bg-white/80 hover:bg-gray-100'}`}
